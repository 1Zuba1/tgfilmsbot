...
admin_menu_main.row(InlineKeyboardButton(text='Партнерство 📜', callback_data='franchise_settings_admin'))
...
admin_menu_text.row(InlineKeyboardButton(text='Партнерство 📜', callback_data='chenneger_franchise_text_settings_admin'))
